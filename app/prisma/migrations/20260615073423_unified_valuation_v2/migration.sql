...
INSERT INTO "new_Listing" ("ac", "address", "availableFrom", "availableTo", "balcony", "bathrooms", "bedrooms", "bikeIncluded", "city", "country", "courtyard", "createdAt", "description", "dishwasher", "dryer", "featuredUntil", "floor", "garden", "gym", "hasElevator", "hasParking", "id", "isActive", "isFeatured", "isVerified", "lat", "lng", "maxStayDays", "minStayDays", "motifHint", "neighbourhood", "nightlyKeys", "ownerVerified", "paletteHint", "petTypes", "petsAllowed", "photos", "piano", "pool", "postcard", "propertyType", "rooftop", "sizeSqm", "sleeps", "stepFreeAccess", "tags", "title", "updatedAt", "userId", "verificationReviewedAt", "verificationReviewerId", "verificationStatus", "verificationSubmittedAt", "verificationVideoUrl", "washer", "wfhDesks", "wfhSetup") SELECT "ac", "address", "availableFrom", "availableTo", "balcony", "bathrooms", "bedrooms", "bikeIncluded", "city", "country", "courtyard", "createdAt", "description", "dishwasher", "dryer", "featuredUntil", "floor", "garden", "gym", "hasElevator", "hasParking", "id", "isActive", "isFeatured", "isVerified", "lat", "lng", "maxStayDays", "minStayDays", "motifHint", "neighbourhood", "nightlyKeys", "ownerVerified", "paletteHint", "petTypes", "petsAllowed", "photos", "piano", "pool", "postcard", "propertyType", "rooftop", "sizeSqm", "sleeps", "stepFreeAccess", "tags", "title", "updatedAt", "userId", "verificationReviewedAt", "verificationReviewerId", "verificationStatus", "verificationSubmittedAt", "verificationVideoUrl", "washer", "wfhDesks", "wfhSetup" FROM "Listing";
DROP TABLE "Listing";
...
-- CreateIndex
CREATE UNIQUE INDEX "LocationTier_city_key" ON "LocationTier"("city");
