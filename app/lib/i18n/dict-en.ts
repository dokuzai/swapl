...
export const en = {
  ...
  "hero.intro":
    "We're collecting listings ahead of the September 2026 launch. List your place with care and precise detail now and you'll be among the first homes that show up when swaps go live — keys for keys, no cash changing hands, every stay insured end to end.",
  ...
  "cta.confirmation":
    "You're on the list. We'll email you the moment swaps go live — and earlier still if you're in a city where matches are stacking up.",
