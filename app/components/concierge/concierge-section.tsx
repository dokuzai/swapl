  ...
  function buy(slug: string) {
    ...
    start(async () => {
      ...
      if (res.ok && j.url) {
        ...
        setError(j.error ?? t("concierge.processError"));
      }
      setPendingSlug(null);
    });
  }
            ...
            return (
              ...
              >
                <div className="font-mono text-[10px] uppercase tracking-[.1em] mb-1" style={{ color: "var(--navy-3)" }}>
                  {t("concierge.partnerTag", { category: a.category })}
                </div>
              ...
              {includedForUser ? (
                ...
                <div className="mt-3 flex flex-wrap items-center justify-between gap-x-3 gap-y-2">
                  ...
                  {own ? (
                    ...
                    >
                      {pendingSlug === a.slug ? t("concierge.processing") : t("concierge.add")}
                    </button>
                  )}
                </div>
              )}
