...
export const metadata: Metadata = {
  ...
  description:
    "List your home before the September 2026 launch. swapl is a home swap marketplace for trading keys for keys, with no nightly rates and every swap backed by the Swapl Guarantee.",
  ...
  openGraph: {
    ...
    description: "List before launch to join the first homes surfaced for money-free swaps backed by the Swapl Guarantee.",
    siteName: "swapl",
    type: "website",
    url: "/",
  },
